...
class View extends \Gcms\View
{
    ...
    {
        return '<tr><td colspan=2></td><td class=center>{LNG_Academic results}</td><td class=center>'.number_format($this->credit, 1, '.', '').'</td><td class=center>'.number_format(Number::division($this->total, $this->credit), 2, '.', '').'</td></tr>';
    }
}
